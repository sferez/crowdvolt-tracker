...
const COLUMNS = [
  ...
  ['change4', '4h',      '',  e => e.current?.change4h ?? 0, cellChange('change4h'), 'Moved'],
  ['change',  '24h',     '',  e => e.current?.change24 ?? 0, cellChange('change24'), 'Moved'],
  ['change3', '3d',      '',  e => e.current?.change3d ?? 0, cellChange('change3d'), 'Moved'],
  ['change7', '7d',      '',  e => e.current?.change7d ?? 0, cellChange('change7d'), 'Moved'],
